...
export { default as Thanks } from './Thanks/Thanks.js';
...
export { default as WorkflowMobile } from './Workflow/WorkflowMobile.js';
export { default as ProjectsMobile } from './Projects/ProjectsMobile.js';
export { default as ThanksMobile } from './Thanks/ThanksMobile.js';